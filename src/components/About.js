    ...
    return (
        <div id="about" className="container-fluid " style={{ minHeight: "80vh" }}>
            <div className="container pt-4 " >
                ...
                <p className="text-center">
                    Happy exploring <br />
                    The <strong>mes tournées</strong> Team
                </p>
            </div>
        </div >
    )
